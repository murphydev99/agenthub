      ...
      <div className="flex-1 overflow-hidden">
        <div className="h-full flex">
          ...
          <div className="hidden lg:block w-64 bg-white border-r border-gray-200 overflow-y-auto">
            ...
            {/* Store Info - if available from claims */}
            ...
            <div className="p-4 border-t border-gray-100">
              <div className="space-y-3">
                <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Quick Stats</div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-gray-600">Open Tickets</span>
                    <span className="px-2 py-0.5 bg-amber-100 text-amber-700 rounded-full font-medium">12</span>
                  </div>
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-gray-600">Pending Training</span>
                    <span className="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full font-medium">3</span>
                  </div>
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-gray-600">System Status</span>
                    <span className="px-2 py-0.5 bg-emerald-100 text-emerald-700 rounded-full font-medium">All OK</span>
                  </div>
                </div>
              </div>
            </div>
